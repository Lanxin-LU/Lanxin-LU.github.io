...
- <strong>The Time–Frequency Co-Movement Between Bitcoin and U.S. Equities: Evidence from Sentiment Shocks and Safe-Haven Substitution</strong>, with Yike Wang, Valerio Poti\
<strong>Abstract</strong>: This paper investigates the time–frequency co-movement between Bitcoin and the U.S. equity market using wavelet coherence (WTC) and partial wavelet coherence (PCW) methods. The results reveal significant positive coherence, particularly in high- and medium-frequency bands. Controlling for the VIX index notably reduces the coherence, suggesting that shared market sentiment plays a key role in driving the co-movement. Further conditioning on traditional safe-haven assets such as gold and the U.S. dollar index weakens the coherence to a lesser extent, indicating limited substitution effects. 
...
- [A Data-Driven Stock Relation Extraction and Portfolio Optimization Method through Convolution](https://doi.org/10.1145/3768292.3770353), with Yingjie Niu, Ruihai Dong, Valerio Poti
